...
public class MyShiroApplication {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(MyShiroApplication.class);


	public static void main(String[] args) {

        ConfigurableApplicationContext context = SpringApplication.run(MyShiroApplication.class, args);
